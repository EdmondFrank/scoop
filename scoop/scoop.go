...
var (
    ...
    fromDurable      = flag.Bool("from-durable", true, "Define the from queue deceleration to be durable")
    toDurable        = flag.Bool("to-durable", true, "Define the to queue deceleration to be durable")
